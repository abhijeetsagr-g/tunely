...
List<Tune> sortTunes(List<Tune> tunes, SortType sort, SortOrder order) {
  ...
  switch (sort) {
    case SortType.name:
      sorted.sort((a, b) => a.title.toLowerCase().compareTo(b.title));
    case SortType.duration:
      sorted.sort((a, b) => a.duration.compareTo(b.duration));
    case SortType.album:
      sorted.sort((a, b) => a.album.toLowerCase().compareTo(b.album));
    case SortType.artist:
      sorted.sort((a, b) => a.artist.toLowerCase().compareTo(b.artist));
